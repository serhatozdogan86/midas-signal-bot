...
children.push(
  ...
  tocLine('Bölüm 5 — SHORT (Kısa) Pozisyonlar: Neden Daha Sıkı Kurallar?', 19, true),
  tocLine('Bölüm 6 — Portföy Risk Yönetimi: "Isı Motoru"', 20, true),
  tocLine('Bölüm 7 — Maliyet Modeli ve "Net-R"', 22, true),
  tocLine('Bölüm 8 — Gölge Mod ve Gerçek Paraya Geçiş Kriteri', 23, true),
  tocLine('Bölüm 9 — Dashboard Kullanım Kılavuzu', 25, true),
  tocLine('Bölüm 10 — Sık Sorulan Sorular', 27, true),
  tocLine('Bölüm 11 — Sözlük (A\'dan Z\'ye)', 28, true),
  tocLine('Sorumluluk Reddi', 29, true),
  pageBreak(),
);
...
children.push(
  ...
  h2('4.10 Vaka İncelemesi 1 — Baştan Sona Bir Sinyalin Doğuşu'),
  p('Aşağıdaki örnek kurgusaldır ("ACME Corp" gerçek bir şirket değil); amaç, 9 basamağın hepsinin gerçek sayılarla nasıl geçildiğini somut olarak göstermek. Piyasa BULL rejiminde.'),
  table(
  ...
  new Paragraph({ spacing: { after: 240 } }),
  p('Sonuç: ACME için LONG sinyali — giriş bölgesi ~$82,10, stop $80,35, TP1 $83,85, TP2 $85,60, RR 2,0, güven H. Bu paket olduğu gibi Telegram\'a düşer.'),

  h2('4.11 Vaka İncelemesi 2 — Bir Hisse Neden Elenir?'),
  p('Her aday sinyale dönüşmez; asıl işi eleme yapar. Aşağıdaki kurgusal örnek ("BOLT Inc."), teknik yapısı gayet iyi görünen bir hissenin nasıl ve neden durdurulduğunu gösterir.'),
  table(
    ['Basamak', 'Gözlem', 'Sonuç'],
    [
  ...
  new Paragraph({ spacing: { after: 240 } }),
  quoteBox('Teknik yapı burada mükemmel görünüyordu; hisse basamak 3\'e kadar her şeyi geçti. Ama bilanço riski öngörülemez olduğu için bot durdu. Bilanço iyi gelseydi belki bir fırsat kaçmış olurdu — kötü gelseydi, teknik kurulum bir gecede anlamsızlaşırdı. Bot, öngörülemeyen bir riski, öngörülebilir bir fırsata her zaman tercih eder.'),

  h2('4.12 Vaka İncelemesi 3 — SHORT Tarafında Aynalı Bir Örnek'),
  p('Piyasa BEAR rejiminde. Kurgusal "DUSK Holdings": fiyat 50 günlük ortalamanın altında, 200 günlük ortalamanın altında, LH/LL (düşen tepeler/dipler) yapısında.'),
  bullet('SETUP: Fiyat, düşen 20 saatlik ortalamaya doğru YUKARI sıçradı; RSI(3) 88\'e çıktı (aşırı ALIM — pullback\'in ayna görüntüsü); ardından kırmızı bir dönüş mumu oluştu.'),
  bullet('Sinyal: Giriş $45,20 · Stop $46,80 (risk $1,60) · TP1 $43,60 (RR 1,0) · TP2 $42,00 (RR 2,0).'),
  p('Mantık aynı, yön ters: "Düşüş trendi hâlâ sağlam, sadece kısa bir yukarı soluklanma oldu; ucuza (yani pahalıya) satma fırsatı."'),

  h2('4.13 Güven Etiketi (H/M/L) Nasıl Belirlenir? — Karşılaştırmalı Örnek'),
  table(
...
children.push(
  ...
  h2('6.1 Vaka İncelemesi — Bir Günün Portföy Defteri (Kurgusal)'),
  p('Aşağıdaki tablo, ısı motorunun bir gün içinde nasıl işlediğini adım adım gösteriyor. Tüm semboller ve saatler kurgusaldır.'),
  table(
    ...
    [1300, 1300, 1300, 3200, 2600],
  ),
  new Paragraph({ spacing: { after: 200 } }),
  p('Dikkat: #5 (SHORT) engellenmedi, çünkü kendi kümesi (S-Pzt) henüz doluydu değil — "aynı yön/gün" tanımı gereği LONG kümesinin dolu olması SHORT kümesini etkilemez. #4 ve #6 ise aynı LONG kümesine düştüğü için engellendi.'),
  quoteBox('Peki engellenen #4 ve #6\'ya ne oldu? Bot bunları "hayalet pozisyon" olarak (blocked=2) işaretleyip aynı giriş/stop/hedef mantığıyla izlemeye devam eder — gerçek deftere hiç girmeden. Örnek: o gün piyasa öğleden sonra geri çekildi ve L-Pzt kümesindeki 3 gerçek pozisyon ortalama −0,9R ile kapandı. #4 ve #6\'nın varsayımsal sonucu da benzer şekilde −0,8R ve −1,1R çıktı — yani bu örnekte tavan, yaklaşık 1,9R\'lik ek bir kaybı gerçek deftere hiç yazdırmadan önledi. (Bazı günler tam tersi de olabilir: tavan iyi bir fırsatı kaçırmış olabilir — bu yüzden hypo_r takibi iki yönlü de dürüstçe raporlanır.)'),
